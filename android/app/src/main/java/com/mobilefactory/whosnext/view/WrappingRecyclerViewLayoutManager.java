...
public class WrappingRecyclerViewLayoutManager extends LinearLayoutManager {
    ...
    public WrappingRecyclerViewLayoutManager(Context context) {
        this(context, VERTICAL, false, false);
    }

    public WrappingRecyclerViewLayoutManager(Context context, int orientation, boolean reverseLayout, boolean isScrollEnabled) {
